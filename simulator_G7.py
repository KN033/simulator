...
class Screens:
    ...
    def default_screen (self):
        while True:
            ...
            startButton=Button(shape=pygame.draw.rect(self.Screen,(219, 48, 122),(640,600,100,40),0,50),pos=(640,600),text_input="Start",font=self.get_font(33),base_color=(255,255,255), hovering_color=(250, 252, 250))
            ...
            pygame.draw.rect(self.Screen,(255,255,255),(800, 130, 300, 400),0,25)
